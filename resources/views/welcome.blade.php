...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/vendors/flag-icons.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('css/vendors/select2-bootstrap.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('css/vendors/jquery-jvectormap.css') }}">
    <link rel="stylesheet" href="{{ asset('css/vendors/themify-icons.css') }}">
